...
public $doctors = array(
    array('name' => 'Иванов Иван', 'specialty' => 'Хирург'),
    array('name' => 'Иванов Маским', 'specialty' => 'Врач'),
    array('name' => 'Иванов Руслан', 'specialty' => 'Терапевт'),
    array ('name' => 'Петров Алексей', 'specialty' => 'Кардиолог'),
    array('name' => 'Сидоров Дмитрий', 'specialty' => 'Врач общей практики')
);
...
$rmDoctor->removeAllDoctorByName("Иванов"); //Remove All "Иванов"
